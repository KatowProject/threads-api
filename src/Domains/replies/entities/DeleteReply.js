module.exports = class DeleteReply {
    constructor(payload) {
    ...
    _verifyPayload({ replyId, commentId, threadId, userId }) {
        if (!replyId || !commentId || !threadId || !userId) {
            throw new Error('DELETE_REPLY.NOT_CONTAIN_NEEDED_PROPERTY');
        }

        if (typeof replyId !== 'string' || typeof commentId !== 'string' || typeof threadId !== 'string' || typeof userId !== 'string') {
